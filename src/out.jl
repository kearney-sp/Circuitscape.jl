...
function write_aagrid(cmap, name, cfg, flags, hbmeta; 
	...
	Libz.ZlibDeflateOutputStream(f, "ncols         $(hbmeta.ncols)\n")
        Libz.ZlibDeflateOutputStream(f, "nrows         $(hbmeta.nrows)\n")
        Libz.ZlibDeflateOutputStream(f, "xllcorner     $(hbmeta.xllcorner)\n")
        Libz.ZlibDeflateOutputStream(f, "yllcorner     $(hbmeta.yllcorner)\n")
        Libz.ZlibDeflateOutputStream(f, "cellsize      $(hbmeta.cellsize)\n")
        Libz.ZlibDeflateOutputStream(f, "NODATA_value  $(hbmeta.nodata)\n")
